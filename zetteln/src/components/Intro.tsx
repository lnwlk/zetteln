...
export default function AppFeature() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-7xl flex-col md:flex-row md:items-center">
      <div className="px-4 pt-16 pb-8 md:w-1/2 md:px-8">
      ...
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center md:h-screen md:w-1/2">
        {/* Toggle Switch */}
        <div className="absolute top-0 flex w-full items-center justify-center text-base md:pt-8">
        ...
        <div
          ...
          className={`absolute top-12 h-3/4 w-[80%] rounded-4xl border bg-white transition duration-600 ease-in-out md:top-auto ${topDiv === 'initial' ? 'z-10 -translate-x-6 scale-100 border-gray-100 shadow-2xl' : 'z-0 -translate-x-14 scale-80 border-gray-300 bg-transparent'}`}
        >
          <div
        ...
        <div
          ...
          className={`absolute top-12 h-3/4 w-[80%] rounded-4xl border bg-white transition duration-600 ease-in-out md:top-auto ${topDiv === 'morphed' ? 'z-10 translate-x-6 scale-100 border-gray-100 shadow-2xl' : 'z-0 translate-x-14 scale-80 border-gray-300'}`}
        >
          <div
