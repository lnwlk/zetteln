...
export default function AppWaitlistPage() {
  return (
    <>
      <div className="mx-auto flex max-w-3xl flex-col gap-8 px-4 py-40 text-center md:px-8">
        ...
        <p>
          ...
          Lösungen anbieten. Deshalb wird zettel aktuell in ausgewählen Pilotprojekten getestet und verbessert. Du
